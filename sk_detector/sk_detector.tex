...
\input{sk_detector/overview}
\input{sk_detector/cherenkov_radiation}
\input{sk_detector/tank}
\input{sk_detector/pmts}
\input{sk_detector/daq}
\input{sk_detector/water_system}
\input{sk_detector/calibration}